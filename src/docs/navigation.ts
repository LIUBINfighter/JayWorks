...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: "core-features", file: "zh-cn/guide/core-features.mdx", label: "核心功能" },
      {
        ...
        file: "zh-cn/guide/interactive-diagrams.mdx",
        label: "交互式图表",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "plugin-settings",
        file: "zh-cn/reference/plugin-settings.mdx",
        label: "插件设置",
        draft: true,
      },
    ],
  },
  {
    ...
    items: [
      // zh-cn
      {
        ...
        file: "zh-cn/developer/rendering-pipeline.mdx",
        label: "渲染管线",
      },
      { id: "navigation-config", file: "zh-cn/developer/navigation-config.mdx", label: "导航配置" },
      {
        id: "frontmatter-schema",
        file: "zh-cn/developer/frontmatter-schema.mdx",
        label: "Frontmatter 规范",
      },
      {
        id: "mdx-debug-record",
        file: "zh-cn/developer/mdx-debug-record.mdx",
        label: "MDX 调试记录",
      },
      {
        type: "category",
        ...
        items: [
          {
            id: "style-guide-overview",
            file: "zh-cn/developer/style-guide/overview.mdx",
            label: "概览",
          },
          {
            id: "style-guide-obsidian",
            file: "zh-cn/developer/style-guide/obsidian-theme.mdx",
            label: "Obsidian 风格适配",
          },
        ],
      },
