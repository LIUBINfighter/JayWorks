    ...
    <div className="jw-search-box" ref={boxRef}>
      <div className="jw-search-input-wrap">
        <input
          ...
          onKeyDown={handleKey}
        />
        <span className="jw-search-beta" title="Search feature in beta">
          beta
        </span>
      </div>
        ...
        <ul className="jw-search-result-list">
          {results.map((r, i) => (
            ...
            >
              ...
              {r.snippet && (
                <div
                  className="jw-search-item-snippet"
      ...
      {open && results.length === 0 && q.trim() && <div className="jw-search-empty">无结果</div>}
    </div>
  );
};
